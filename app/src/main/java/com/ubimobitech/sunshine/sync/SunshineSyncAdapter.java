package com.ubimobitech.sunshine.sync;
...
import com.ubimobitech.sunshine.MainActivity;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        try {
            handleActionFetchData(prefs.getString(getContext().getString(R.string.pref_location_key),
     ...
     * parameters.
     */
    private void handleActionFetchData(String locationSetting)
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst() && prefs.getBoolean(notificationKey, true)) {
